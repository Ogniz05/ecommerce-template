...
export default function NotFound() {
  ...
  return (
    <div className="page-wrapper min-h-screen flex items-center justify-center overflow-hidden relative">
      {/* Background orbs */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-tint blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-ink/5 blur-3xl" />
      ...
      <div className="relative text-center px-4 max-w-lg">
        ...
        >
          ...
          <motion.div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full bg-tint blur-2xl"
        ...
        >
          <h1 className="font-display font-bold text-3xl text-ink mb-3">Pagina Non Trovata</h1>
